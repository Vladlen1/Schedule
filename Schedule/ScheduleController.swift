...
//    private var emailUser = UserDefaults.standard.value(forKey: "email") as! String
    ...
    dynamic var scheduleListPresenter = ScheduleListPresenter()
...
//    var currentDate = String()
    ...
    override func viewDidLoad() {
        ...
        self.scheduleListPresenter.scheduleController = self
        scheduleListPresenter.initialize()
//        getCurrentDate()
//        menuSegue()
//        longPress()
//        getScheduleInform()
...
extension ScheduleController:   UITableViewDataSource, UITableViewDelegate,  UITextFieldDelegate, UIGestureRecognizerDelegate{
